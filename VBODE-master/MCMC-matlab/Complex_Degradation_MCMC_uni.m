...
for iii=1:length(cdir)
    ...
    prior1= gampdf(cdir(1),1,0.5) * ...
        ...
        gampdf(cdir(8),1,0.5) * ...
        gampdf(cdir(9),1,0.5) * ...
        gampdf(cdir(10),1,0.5) * ...
        gampdf(cdir(11),1,0.5) * ...
        gampdf(cdir(12),1,0.5) * ...
        gampdf(cdir(13),1,0.5) * ...
        gampdf(cdir(14),1,0.5) * ...
        gampdf(cdir(15),1,0.5) * ...
        gampdf(cdir(16),1,0.5) * ...
        gampdf(cdir(17),1,0.5) * ...
        gampdf(cdir(18),1,0.5) ;
    
     prior2= gampdf(cdpr(1),1,0.5) * ...
        gampdf(cdpr(2),1,0.5) * ...
        gampdf(cdpr(3),1,0.5) * ...
        gampdf(cdpr(4),1,0.5) * ...
        gampdf(cdpr(5),1,0.5) * ...
        ...
        gampdf(cdpr(8),1,0.5) * ...
        gampdf(cdpr(9),1,0.5) * ...
        gampdf(cdpr(10),1,0.5) * ...
        gampdf(cdpr(11),1,0.5) * ...
        gampdf(cdpr(12),1,0.5) * ...
        gampdf(cdpr(13),1,0.5) * ...
        gampdf(cdpr(14),1,0.5) * ...
        gampdf(cdpr(15),1,0.5) * ...
        gampdf(cdpr(16),1,0.5) * ...
        gampdf(cdpr(17),1,0.5) * ...
        gampdf(cdpr(18),1,0.5) ;
