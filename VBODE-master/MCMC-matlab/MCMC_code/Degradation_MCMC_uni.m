function [oitdata,oizdata,oigdata,oip3data,odir,odaa] = Degradation_MCMC_uni(itdata,izdata,igdata,ip3data,tir,dir,kir,bir,ubir,cdir,daa)
...
%     mtan=1/4;
    ...
    prior1= 1;
%     (1-tanh(mtan*abs(log10(dir(1)/dir(2))))) * ...
%         (1-tanh(mtan*abs(log10(dir(1)/dir(3))))) * ...
%         (1-tanh(mtan*abs(log10(dir(1)/dir(4))))) * ...
%         (1-tanh(mtan*abs(log10(dir(1)/dir(5))))) * ...
%         (1-tanh(mtan*abs(log10(dir(2)/dir(3))))) * ...
%         (1-tanh(mtan*abs(log10(dir(2)/dir(4))))) * ...
%         (1-tanh(mtan*abs(log10(dir(2)/dir(5))))) * ...
%         (1-tanh(mtan*abs(log10(dir(3)/dir(4))))) * ...
%         (1-tanh(mtan*abs(log10(dir(3)/dir(5))))) * ...
%         (1-tanh(mtan*abs(log10(dir(4)/dir(5)))));
    
    prior2= 1;
%     (1-tanh(mtan*abs(log10(dpr(1)/dpr(2))))) * ...
%         (1-tanh(mtan*abs(log10(dpr(1)/dpr(3))))) * ...
%         (1-tanh(mtan*abs(log10(dpr(1)/dpr(4))))) * ...
%         (1-tanh(mtan*abs(log10(dpr(1)/dpr(5))))) * ...
%         (1-tanh(mtan*abs(log10(dpr(2)/dpr(3))))) * ...
%         (1-tanh(mtan*abs(log10(dpr(2)/dpr(4))))) * ...
%         (1-tanh(mtan*abs(log10(dpr(2)/dpr(5))))) * ...
%         (1-tanh(mtan*abs(log10(dpr(3)/dpr(4))))) * ...
%         (1-tanh(mtan*abs(log10(dpr(3)/dpr(5))))) * ...
%         (1-tanh(mtan*abs(log10(dpr(4)/dpr(5)))));
    
    p1=1; p2=1;
    u=rand;
%     if u<min([1 f*prior2*p1/(prior1*p2)])    
