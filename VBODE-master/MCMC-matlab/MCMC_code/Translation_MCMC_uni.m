...
%     mtan=1/4;
    ...
    prior1= 1;
%     (1-tanh(mtan*abs(log10(tir(1)/tir(2))))) * ...
%         (1-tanh(mtan*abs(log10(tir(1)/tir(3))))) * ...
%         (1-tanh(mtan*abs(log10(tir(1)/tir(4))))) * ...
%         (1-tanh(mtan*abs(log10(tir(2)/tir(3))))) * ...
%         (1-tanh(mtan*abs(log10(tir(2)/tir(4))))) * ...
%         (1-tanh(mtan*abs(log10(tir(3)/tir(4)))));
    
    prior2= 1;
%     (1-tanh(mtan*abs(log10(tpr(1)/tpr(2))))) * ...
%         (1-tanh(mtan*abs(log10(tpr(1)/tpr(3))))) * ...
%         (1-tanh(mtan*abs(log10(tpr(1)/tpr(4))))) * ...
%         (1-tanh(mtan*abs(log10(tpr(2)/tpr(3))))) * ...
%         (1-tanh(mtan*abs(log10(tpr(2)/tpr(4))))) * ...
%         (1-tanh(mtan*abs(log10(tpr(3)/tpr(4)))));
