function dC = multi_degradation_ODE(t,C)
...
% TOC1-ZTL1 complex
dC(6) = bb*C(1)*C(2) - ubtz1*C(6) - (dt*deci(1)+dz1*(1-deci(1)))*C(6);

% TOC1-ZTL2 complex
dC(7) = bb*C(1)*C(3) - ubtz2*C(7) - (dt*deci(1)+dz2*(1-deci(1)))*C(7);

% TOC1-GI protein
dC(8) = bb*C(1)*C(4) - ubtg*C(8) - (dt*deci(2)+dg*(1-deci(2)))*C(8);

% TOC1-PRR3 protein
dC(9) = bb*C(1)*C(5) - ubtp*C(9) - (dt*deci(3)+dp*(1-deci(3)))*C(9);

% ZTL1-GI protein
dC(10) = bb*C(2)*C(4) - ubzg1*C(10) - (dz1*deci(4)+dg*(1-deci(4)))*C(10);

% ZTL2-GI protein
dC(11) = bb*C(3)*C(4) - ubzg2*C(11) - (dz2*deci(4)+dg*(1-deci(4)))*C(11);

% ZTL1-PRR3 protein
dC(12) = bb*C(2)*C(5) - ubzp1*C(12) - (dz1*deci(5)+dp*(1-deci(5)))*C(12);

% ZTL2-PRR3 protein
dC(13) = bb*C(3)*C(5) - ubzp2*C(13) - (dz2*deci(5)+dp*(1-deci(5)))*C(13);

% GI-PRR3 protein
dC(14) = bb*C(4)*C(5) - ubgp*C(14) - (dg*deci(6)+dp*(1-deci(6)))*C(14);
