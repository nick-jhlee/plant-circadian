...
for iii=1:length(ubir)
    ...
    prior1=(tanh(mtan*log10(ubir(1)/bir(1)))/2+1/2) * ...
        ...
        (tanh(mtan*log10(10^6*ubir(5)/bb))) * ...   % ZTL_d - GI: unbinding = 10^-6 * binding
        (tanh(mtan*log10(10^8*ubir(6)/bb)));   % ZTL_l - GI: unbinding = 10^-8 * binding
    
    prior2=(tanh(mtan*log10(ubpr(1)/bir(1)))/2+1/2) * ...
        ...
        (tanh(mtan*log10(10^6*ubpr(5)/bb))) * ...   % ZTL_d - GI: unbinding = 10^-6 * binding
